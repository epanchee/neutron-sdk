...
pub fn new_register_distribution_fee_pool_query_msg(
    ...
    let kv_key = KVKey {
        ...
        key: Binary::from(create_fee_pool_key()?),
    };
...
pub fn new_register_validators_signing_infos_query_msg(
    ...
    for validator in validators {
        ...
        let kv_key = KVKey {
            ...
            key: Binary::from(create_validator_signing_info_key(&valcons_addr)?),
        };
...
pub fn new_register_delegator_unbonding_delegations_query_msg(
    ...
    for v in validators {
        ...
        keys.push(KVKey {
            path: STAKING_STORE_KEY.to_string(),
            key: Binary::from(create_unbonding_delegation_key(&delegator_addr, &val_addr)?),
        })
    }
